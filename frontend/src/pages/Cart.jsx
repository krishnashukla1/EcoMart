...
//       <th className="p-3 text-center border border-gray-300">Qty</th>
...
//         <td className="p-3 border border-gray-300">{item.product.name}</td>
//         <td className="p-3 text-right border border-gray-300">${item.price}</td>
...
//             <button onClick={handleClear} className="px-4 py-2 mt-2 text-white bg-red-600 rounded">Clear Cart</button>
//             <button onClick={handleCheckout} className="px-4 py-2 mt-2 ml-2 text-white bg-blue-600 rounded">Checkout</button>
//           </div>
//         </>
//       )}
//     </div>
